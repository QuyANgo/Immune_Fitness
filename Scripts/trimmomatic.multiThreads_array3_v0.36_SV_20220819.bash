...
#cd $data; ls | cut -d _ -f 1-3 | uniq > $here/Scripts/fastqRemainList3.txt --> this should be generated before the job array is submitted
id=$(sed -n ${SLURM_ARRAY_TASK_ID}p $here/Scripts/fastqRemainList3.txt)
